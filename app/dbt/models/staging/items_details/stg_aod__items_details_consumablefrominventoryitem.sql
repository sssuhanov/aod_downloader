select
    (jsonb_array_elements(i.consumablefrominventoryitem)->>'@uniquename')::text as uniquename,
    ...
    (jsonb_array_elements(i.consumablefrominventoryitem)->>'@shopcategory')::text as shopcategory,
    (jsonb_array_elements(i.consumablefrominventoryitem)->>'@shopsubcategory1')::text as shopsubcategory1,
